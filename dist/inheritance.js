...
var SubTask = function (_Task) {
    ...
    _createClass(SubTask, [{
        key: 'complete',
        value: function complete() {
            _get(SubTask.prototype.__proto__ || Object.getPrototypeOf(SubTask.prototype), 'complete', this);
...
var task = new Task('Do smth');
var subtask = new SubTask('Learnign es6', task);
